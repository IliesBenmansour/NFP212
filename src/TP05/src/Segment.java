...
/**
 * Un segment est défini pas ses deux points qui constituent ses extrémités. Un
 * segment peut être affiché et translaté.
 *
...
public class Segment {
	...
	/**
	 * @deprecated Cette méthode a changé de nom pour respecter la convention de
	 *             nommage préconisée par Sun pour Java.
	 * @see #getLongueur()
	 */
	@Deprecated
	...
	public void dessiner(Afficheur ecran) {
		ecran.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(), this.extremite2.getX(),
				this.extremite2.getY(), couleur);
	}
