...
public class SujetCercleTest {
	...
	public void testerToString() {
		assertEquals("E15: toString() redéfinie ? Correctement ?", "C2.5@(1.0, 2.0)", C1.toString());
	}
	...
	public void testerE18() {
		...
		memesCoordonnees("E18 : erreur si translation du centre", new Point(1, 2), C1.getCentre());
		A.translater(10, 20);
		memesCoordonnees("E18 : erreur si translation de A", new Point(1, 2), C1.getCentre());
	}
