...
/**
 * Point modÃ©lise un point gÃ©omÃ©trique dans un plan Ã©quipÃ© d'un repÃ¨re
 * cartÃ©sien. Un point peut Ãªtre affichÃ© et translatÃ©. Sa distance par
 * rapport Ã un autre point peut Ãªtre obtenue.
 *
...
//  Gestion de la couleur
	 ...
	 * mÃ©moire ne dÃ©truise l'objet. Attention toutefois, on ne sait // pas quand
	 * ces ressources seront libÃ©rÃ©es et il est donc // dangereux de s'appuyer sur
	 * ce mÃ©canisme pour libÃ©rer des // ressources qui sont en nombre limitÃ©. //
	 * // D'autre part, pour Ãªtre sÃ»r que les mÃ©thodes << finalize >> // sont
	 * appelÃ©es avant la fermeture de Java, il faut appeler la // mÃ©thode statique
	 * : // System.runFinalizersOnExit(true) // protected void finalize() {
	 * System.out.print("DESTRUCTION du point : "); this.afficher();
	 * System.out.println(); }
	 */
