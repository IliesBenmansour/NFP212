...
public class Console {
	...
	/**
	 * Lire un entier à partir du clavier après avoir affiché une invite. Resaisie
	...
	/**
	 * Lire un réel à partir du clavier après avoir affiché une invite. Resaisie
	 * dans le cas d'une erreur de l'utilisateur.
	 *
	 * @return le réel lu
	 */
	...
	/**
	 * Lire un entier à partir du << flot >> d'entrée après avoir affiché une
	 * invite. Resaisie dans le cas d'une erreur de l'utilisateur.
	 *
	 * @return l'entier lu
	 */
