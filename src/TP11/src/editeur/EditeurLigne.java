package TP11.src.editeur;

import java.awt.Menu;

import TP11.src.editeur.commande.CommandeAjouterFin;
import TP11.src.editeur.commande.CommandeCurseurAvancer;
import TP11.src.editeur.commande.CommandeCurseurReculer;

/**
 * Un éditeur pour une ligne de texte. Les commandes de l'éditeur sont
 * accessibles par un menu.
 *
...
public class EditeurLigne {
	...
	public EditeurLigne(Ligne l) {
		...
		menuPrincipal.ajouter("Avancer le curseur d'un caractère", new CommandeCurseurAvancer(ligne));
		menuPrincipal.ajouter("Reculer le curseur d'un caractère", new CommandeCurseurReculer(ligne));
	}
