...
public interface Ligne {
	...
	/**
	 * Afficher la ligne en mettant entre crochets [] le caractère courant. Si la
	 * ligne est vide, un seul caractère tilde(~) est affiché.
	 */
	/* @ pure @ */ void afficher();

	/**
	 * Ajouter le caractère c à la fin de la ligne. Le curseur reste sur le même
	 * caractère.
	 */
	// @ ensures getLongueur() == \old(getLongueur()) + 1; // caractère ajouté
	...
	/**
	 * Ajouter le caractère c au début de la ligne Le curseur reste sur le même
	 * caractère.
	 */
	// @ ensures getLongueur() == \old(getLongueur()) + 1; // caractère ajouté
	...
	/**
	 * supprimer le premier caractère de la ligne. Le curseur reste sur le même
	 * caractère.
	 */
	// @ requires getLongueur() > 0;
